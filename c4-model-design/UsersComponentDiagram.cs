...
{
	public class UsersComponentDiagram
	{
        ...
        public UsersComponentDiagram(C4 c4, ContextDiagram contextDiagram, ContainerDiagram containerDiagram)
		{
			this.c4 = c4;
		...
		private void CreateView() {
			string title = "Users Component Diagram";
