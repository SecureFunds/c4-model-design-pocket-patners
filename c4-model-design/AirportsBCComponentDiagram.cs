...
namespace c4_model_design
{
	public class AirportsBCComponentDiagram
    {
		...
		{
            DomainLayer = containerDiagram.ApiRest.AddComponent("Domain Layer Airports", "", "NodeJS (NestJS)");
            InterfaceLayer = containerDiagram.ApiRest.AddComponent("Interface Layer Airports", "", "NodeJS (NestJS)");
            ApplicationLayer = containerDiagram.ApiRest.AddComponent("Application Layer Airports", "", "NodeJS (NestJS)");
            InfrastructureLayer = containerDiagram.ApiRest.AddComponent("Infrastructure Layer Airports", "", "NodeJS (NestJS)");
        }
