...
namespace c4_model_design
{
	public class VaccinesBCComponentDiagram
    {
		...
		{
			DomainLayer = containerDiagram.ApiRest.AddComponent("Domain Layer Vaccines", "", "NodeJS (NestJS)");
            InterfaceLayer = containerDiagram.ApiRest.AddComponent("Interface Layer Vaccines", "", "NodeJS (NestJS)");
            ApplicationLayer = containerDiagram.ApiRest.AddComponent("Application Layer Vaccines", "", "NodeJS (NestJS)");
            InfrastructureLayer = containerDiagram.ApiRest.AddComponent("Infrastructure Layer Vaccines", "", "NodeJS (NestJS)");
		}
